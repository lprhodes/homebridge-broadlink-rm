...
To develop Homebridge Broadlink RM plugin you must have Node.js 7.6 or later installed, and a modern code editor such as [VS Code](https://code.visualstudio.com/).
