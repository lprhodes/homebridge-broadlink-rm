...
const { AirCon2, Switch } = require('../accessories')

const data = {
  on: 'ON',
  off: 'OFF',
  cool16: 'TEMPERATURE_16',
  cool18: 'TEMPERATURE_18',
  heat23: 'TEMPERATURE_23',
  heat26: 'TEMPERATURE_26',
  heat30: 'TEMPERATURE_30',
};
...
describe('airConAccessory', async () => {
  ...
  it ('default config', async () => {
    ...
    const airConAccessory = new AirCon2(null, config, 'FakeServiceManager');
